            ...
            <div className='container'>
                ...
                <form onSubmit={handleSubmit}>
                    <div className='input-field'>
                        ...
                        placeholder='e.g. Charlie and the Chocolate Factory' className='validate' required />
                    ...
                    <div className='input-field'>
                        ...
                        placeholder='e.g. Roald Dahl' className='validate' required />
                        <label className='active' htmlFor='author'>
                            Author
                        </label>
                    </div>
                    <div className='input-field center'>
                        <button type='submit' className='btn waves-effect waves-light amber darken-2'>
